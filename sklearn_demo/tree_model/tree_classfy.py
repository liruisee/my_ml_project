...
class RandomForestModel(LoadDataModel):

    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.init_model = RandomForestClassifier(n_estimators=20)
...
class AdaBoostModel(LoadDataModel):

    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.init_model = AdaBoostClassifier(n_estimators=100)
...
class GbdtModel(LoadDataModel):
    ...
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.init_model = GradientBoostingClassifier(n_estimators=100, learning_rate=1.0, max_depth=1, random_state=0)
